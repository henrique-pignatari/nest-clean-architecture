...
describe('UserController update password e2e tests', () => {
  ...
  describe('POST /users', () => {
    ...
    it('should return an error with 404 code when id not found', async () => {
      const res = await request(app.getHttpServer())
        .patch('/users/fakeId')
        .send(updatePasswordDto)
        .expect(404);
    ...
    it('should return an error with 422 code when oldPassword field is invalid', async () => {
