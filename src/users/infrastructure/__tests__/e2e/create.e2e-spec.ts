...
describe('UserController create e2e tests', () => {
  ...
  describe('POST /users', () => {
    ...
    it('should return an error with 422 code when email field is invalid', async () => {
      signupDto.email = 'not an email';
    ...
    it('should return an error with 422 code when password field is invalid', async () => {
    ...
    it('should return an error with 422 code when invalid field is sent', async () => {
      const res = await request(app.getHttpServer())
        .post('/users')
    ...
    it('should return an error with 409 code when email is duplicate', async () => {
